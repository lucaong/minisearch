...
class MiniSearch {
  ...
  *
  * **Warning:** JSON (de)serialization of the index is inefficient in some
  * browsers (e.g. iOS Safari), and it is often more performant to just rebuild
  * the index on the fly. For this reason, the current implementation is to be
  * considered a _beta_ feature, subject to breaking changes changes in future
  * releases.
  *
